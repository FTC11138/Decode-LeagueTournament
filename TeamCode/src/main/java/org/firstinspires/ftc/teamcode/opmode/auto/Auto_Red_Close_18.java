...
@Autonomous(name = "Auto_12_Red_Close_18")
@Configurable
public class Auto_Red_Close_18 extends LinearOpMode {
    ...
    public static double shoot4X = shootX;
    public static double shoot4Y = shootY;
    public static double shoot4Heading = shootHeading;
    ...
    public void buildPaths() {
        ...
        shoot4Path = buildPath(intake32Pose, shoot4Pose);
    ...
    public void runOpMode() {
        ...
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        ...
                        new WaitCommand(200),
                        new PathCommand(shoot4Path).andThen(
                                new WaitCommand(1000),
                                new InstantCommand(() -> robot.spindexerTestSubsystem.rotateShootCW())
                        ),
                        new WaitCommand(600),
