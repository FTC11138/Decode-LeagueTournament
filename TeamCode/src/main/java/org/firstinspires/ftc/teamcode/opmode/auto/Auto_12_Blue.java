...
public class Auto_12_Blue extends LinearOpMode {
    ...
    public static double startX = 31;
    ...
    public void buildPaths() {
        ...
        intake1Path = buildPath(shoot0Pose, intake1Pose, 0.05);
...
//                                    new TurretStateCommand(TurretOdometrySubsystem.TurretState.TRACK_POINT)
                        ...
                        new WaitCommand(500),
                        new PathCommand(intake1Path, 0.34),
                        ...
                        new PathCommand(intake22Path, 0.33),
                        ...
                        new PathCommand(intake32Path, 0.33),
