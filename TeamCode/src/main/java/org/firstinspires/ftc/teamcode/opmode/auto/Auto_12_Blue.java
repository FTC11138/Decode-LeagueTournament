...
public class Auto_12_Blue extends LinearOpMode {
    ...
    public static double startY = 134.77;
    public static double startHeading = 90;


    public static double shoot0X = 59.5;
    public static double shoot0Y = 84;
    public static double shoot0Heading = 180;


    public static double intake1X = 19;
    public static double intake1Y = 84;
    public static double intake1Heading = 180;


    public static double shoot1X = 59.5;
    public static double shoot1Y = 84;
    public static double shoot1Heading = 180;
    ...
    public static double shoot2X = 59.5;
    public static double shoot2Y = 84;
    public static double shoot2Heading = 180;


    public static double intake3X = 19;
    public static double intake3Y = 35.6;
    public static double intake3Heading = 180;

    public static double shoot3X = 59.5;
    public static double shoot3Y = 84;
    public static double shoot3Heading = 180;
    ...
    public static double control21X = 54;
    public static double control21Y = 53;
    public static double control22X = 69.6;
    public static double control22Y = 61.1;



    public static double control31X = 73;
    public static double control31Y = 29;
    public static double control32X = 43;
    public static double control32Y = 36.5;
    ...
    public void buildPaths() {
        ...
        Pose intakeControl21 = new Pose(control21X, control21Y);
        Pose intakeControl22 = new Pose(control22X, control22Y);

        Pose intakeControl31 = new Pose(control31X, control31Y);
        Pose intakeControl32 = new Pose(control32X, control32Y);



        shoot0Path = buildPath(startPose, shoot0Pose);
        intake1Path = buildPath(shoot0Pose, intake1Pose, 0.1);
        shoot1Path = buildPath(intake1Pose, shoot1Pose, 0.1);
        intake2Path = buildCurve(shoot1Pose, intake2Pose, intakeControl21, intakeControl22, 0.1);
        shoot2Path = buildPath(intake2Pose, shoot2Pose, 0.1);
        intake3Path = buildCurve(shoot2Pose, intake3Pose, intakeControl31, intakeControl32, 0.1);
    ...
    public void runOpMode() {
        ...
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        ...
                        new WaitCommand(300), // to let the launcher charge up
                        //Shoot PreLoad
