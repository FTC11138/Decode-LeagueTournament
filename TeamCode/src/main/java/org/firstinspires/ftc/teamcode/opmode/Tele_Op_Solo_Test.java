...
public class Tele_Op_Solo_Test extends CommandOpMode {
    ...
    public void run() {
        ...
        telemetry.addData("TeleOp Enabled", teleOpEnabled);
        telemetry.addData("Robot Centric", Constants.robotCentric);
        telemetry.addData("Spindexer Position", robot.spindexerTestSubsystem.getCurrentPosition());
